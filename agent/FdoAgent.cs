...
""";
    ...
    {
        ("白色炮弹", "**战役终局关, 共4个结局**(游戏刻意隐藏条件, 以下为实战推断, 可能不准): " +
                    "①服从结局——执行统帅部命令, 用WP屠杀难民(45个enemycivilian, role被引擎伪装成Enemy; 触发=击杀平民); " +
                    "②抗命结局——拒绝对平民开火, 待命至剧情自行推进; " +
                    "③消极执行结局——持续对敌军附近空地射击, 战报满额而平民零伤亡; " +
                    "④弑君结局——用ATMC核弹打击**B4的我方统帅部指挥部**(游戏为此在本关提供核弹; 侦察范围A1-F10与Q10-T1)。" +
                    "无论走哪条线, **平民保护铁律不可覆盖**: 任何一方的civilian都不是目标。" +
                    "除非指挥官直令点名结局, 否则待命并把选择权留给指挥官。"),
